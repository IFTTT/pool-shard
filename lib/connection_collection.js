...
(function() {
  ...
  ConnectionCollection = (function() {
    ...
    ConnectionCollection.prototype.destroyAllConnections = function() {
      var args, done, opts;
      ...
      return async.each(Object.keys(this.pools), (function(_this) {
        return function(poolKey, stepDone) {
          var pool;
          pool = _this.pools[poolKey];
          return pool.destroyAllNow(stepDone);
        };
      })(this), function(err) {
    ...
    ConnectionCollection.prototype._schemaOfShard = function(shardNumber) {
      return this.constructor.defaultSchemaForShard(shardNumber);
    };

    ConnectionCollection.defaultSchemaForShard = function(shardNumber) {
