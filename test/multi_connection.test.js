...
(function() {
  ...
  describe('MultiConnection', function() {
    ...
    return it('should send sql query to all pools and shards', function(done) {
      ...
      return this.multiConnection.query(sql, function(err, result) {
        _this.clientAlpha.queries[0].should.include(_this.schemaAlpha1);
        _this.clientAlpha.queries[1].should.equal(sql);
        _this.clientAlpha.queries[2].should.include(_this.schemaAlpha2);
        _this.clientAlpha.queries[3].should.equal(sql);
        _this.clientBeta.queries[0].should.include(_this.schemaBeta3);
        _this.clientBeta.queries[1].should.equal(sql);
        _this.clientBeta.queries[2].should.include(_this.schemaBeta4);
